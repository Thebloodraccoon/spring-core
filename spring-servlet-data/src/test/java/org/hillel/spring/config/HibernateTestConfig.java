...
import org.hillel.spring.model.entity.*;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;
import org.springframework.context.annotation.Scope;
import org.hillel.spring.repo.RepoTestParent;
...
public class HibernateTestConfig {
    ...
    public SessionFactory sessionFactory() {
        ...
        props.put("hibernate.connection.url", "jdbc:h2:mem:homework");
        ...
        hiberConfig.addAnnotatedClass(Order.class);
        hiberConfig.addAnnotatedClass(Product.class);
